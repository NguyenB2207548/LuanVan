    ...
    >
      ...
      >
        ...
        <div className="overflow-y-auto flex-1">
          {/* Status bar */}
          <div
            className={`px-6 py-3 border-b ${statusCfg.bg} ${statusCfg.border} border-b flex items-center justify-between`}
          >
          ...
          <div className="p-6 space-y-6">
              ...
              <div className="border border-gray-100 rounded-lg p-4 space-y-3">
                ...
                <div className="space-y-1.5 text-sm">
                  ...
                  <div className="flex justify-between gap-4">
                    ...
                    <span className="text-gray-800 text-right leading-relaxed">
            ...
            {order.shipper && (
              <div className="border border-violet-100 bg-violet-50/40 rounded-lg p-4">
                <p className="text-xs font-medium text-violet-500 uppercase tracking-wide flex items-center gap-1.5 mb-2">
                  <Truck size={12} />
                  Shipper phụ trách
                </p>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-gray-50">
                    {order.items.map((item: any) => {
                      ...
                      // 👇 Ưu tiên ảnh Base64. Nếu không có thì lấy ảnh gốc (ghép thêm BASE_URL)
                      const displayImg =
                        item.previewDesign ||
                      ...
                      return (
                        <tr key={item.id} className="hover:bg-gray-50/50">
                          <td className="px-4 py-3">
                            <div className="flex items-center gap-3">
                              {/* 👇 Đổi bg-gray-50 thành bg-white để ảnh PNG trong suốt hiển thị đẹp nhất */}
                              <div className="w-11 h-11 rounded-lg border border-gray-100 bg-white overflow-hidden shrink-0">
                                {displayImg ? (
                                  <img
                                    src={displayImg}
