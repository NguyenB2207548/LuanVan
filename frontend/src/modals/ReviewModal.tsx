...
const ReviewModal = ({ isOpen, onClose, productInfo, onSuccess }: ReviewModalProps) => {
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="flex gap-4 items-center bg-gray-50 p-3 rounded-md">
                        ...
                        <div className="min-w-0">
                            <p className="text-sm font-semibold truncate">{productInfo.name}</p>
                    ...
                    <div className="text-center space-y-3">
                        <p className="text-sm font-medium text-gray-600">Vui lòng chọn mức độ hài lòng</p>
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-gray-700">Chia sẻ trải nghiệm của bạn</label>
                        <textarea
                            value={comment}
